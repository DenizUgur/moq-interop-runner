#!/bin/bash
# build.sh - Build stitcher-moq test client Docker image
#
# Usage:
#   ./build.sh
#
# Source code is embedded in this repository (builds/stitcher-moq/),
# so no external clone is needed. Provenance uses the runner repo commit.

set -euo pipefail

IMPL_NAME="stitcher-moq"
...
IMAGE_NAME="stitcher-moq-client"
